...
<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="col-md-3" style="align:center;">
					...
					<div class="row" style="margin-bottom: 10px; padding-left:80px; padding-top:15px;image-align:center;">
		...
		<div class="col-md-9" style="border-left: 1px solid #9E9E9E;height: 100%;">
					...
					<div class="row"  style="padding-left:100px; padding-bottom:80px;padding-top:20px; height:400px">
						<section >
										...
										<div class="item-info">
											<div class="headline"><?php echo $friendloc0[0];?></div>
													...
													<?php foreach($profilepic0 as $pic){
													  echo '<img src="'.$pic.'"style="padding-bottom:2px;  padding-left:5px"/>';
																	}?>
													<div class="line"></div>
										...
										<div class="image-slider" >
											...
											<ul class="rslides" id="slider1" style="max-height:2500px;">
											  <?php foreach($friendlocpic0 as $pic){
													  echo '<li><img src="'.$pic.'" style=" border:2px solid"/></li>  ';
																	}?>
											</ul>
											 <!-- Slideshow 1 -->
										</div>
					...
					<div class="row"  style="padding-left:200px; padding-bottom:80px; height:500px" >
						</section>
								<div class="item item-type-line">
